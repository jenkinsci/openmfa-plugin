...
public final class UIConstants {
    ...
    public static final class DisplayNames {
        ...
        public static final String MULTI_FACTOR_AUTHENTICATION = "Multi-Factor Authentication";
        public static final String MFA_SECURITY_REALM = "MFA Security Realm (wraps existing realm)";
